   ...
   <div className="listcontainer">
     <section className="listhero">
       ...
       <div className="statgrid">
         ...
         <div className="statbox glass">
           <div className="staticon"><img 
       src= {population} alt='global population image'/></div>
           <div className="statinfo">
         ...
         <div className="statbox glass">
           <div className="staticon"><img src={language} alt='global language'/></div>
           <div className="statinfo">
         ...
         <div className="statbox glass">
           <div className="staticon"><img src={region} alt='total region in the world'/></div>
           <div className="statinfo">
